    ...
    extends Service
{
    ...
    static {
            PARAMETROINTERFAZKEYSERVICE_WSDL_LOCATION = pe.com.bn.wsrestsate.service.external.domain.ParametroInterfazKeyService.class.getResource("/WEB-INF/wsdl/ParametroInterfazKey.wsdl");
